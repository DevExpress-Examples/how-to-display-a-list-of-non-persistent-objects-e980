...
namespace UnboundListView.Module {
    public partial class ShowDuplicateBooksController : ViewController {
        ...
        void showDuplicatesAction_CustomizePopupWindowParams(object sender, CustomizePopupWindowParamsEventArgs e) {
            ...
            foreach(Book book in ((ListView)View).CollectionSource.Collection) {
            ...
            View view = Application.CreateListView(Application.GetListViewId(typeof(Duplicate)), collectionSource, false);
            ((ListView)view).Editor.AllowEdit = false;
            e.View = view;
